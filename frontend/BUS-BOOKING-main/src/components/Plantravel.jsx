...
class Plantravel extends Component {
    ...
    search = (e) =>{
        ...
        Bookingservice.search(source, destination).then((res) =>{
            this.setState({bus:res.data});
        });
    }
    savetravel = (e) => {
        e.preventDefault();
        const { source, destination, date, noofpassengers, buscode } = this.state;
        const booking = {
            username: window.localStorage.getItem("x"),
            source,
            destination,
            date,
            noofpassengers,
        ...
        <div>
            <div className="container">
                <div className="card col-md-6 offset-md-3 offset-md-3">
                    <h3 className="text-center">Plan travel</h3>
